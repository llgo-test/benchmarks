...
| `base64` | 2275731 | LLGo · deadcode drop | 1048137 | -53.9% |
...
| `checksum` | 2264417 | LLGo · deadcode drop | 1021418 | -54.9% |
...
| `conv-wasi` | 2608089 | LLGo · deadcode drop | 1834715 | -29.7% |
...
| `fibonacci` | 2230899 | LLGo · deadcode drop | 943870 | -57.7% |
...
| `grep` | 2848917 | LLGo · deadcode drop | 1743038 | -38.8% |
...
| `glob` | 2257634 | LLGo · deadcode drop | 1270363 | -43.7% |
...
| `json-wasi` | 3314587 | LLGo · deadcode drop | 2830255 | -14.6% |
...
| `llimport` | 8423078 | LLGo · deadcode drop | 33623702 | +299.2% |
...
| `path-report` | 2381190 | LLGo · deadcode drop | 1614063 | -32.2% |
...
| `sha-wasi` | 2780972 | LLGo · deadcode drop | 2148131 | -22.8% |
...
| `word-count` | 2253620 | LLGo · deadcode drop | 1242025 | -44.9% |
...
| `base64` | 96760 | LLGo · deadcode drop | 1048137 | +983.2% |
...
| `checksum` | 92685 | LLGo · deadcode drop | 1021418 | +1002.0% |
...
| `conv-wasi` | 201149 | LLGo · deadcode drop | 1834715 | +812.1% |
...
| `fibonacci` | 62386 | LLGo · deadcode drop | 943870 | +1413.0% |
...
| `grep` | 303772 | LLGo · deadcode drop | 1743038 | +473.8% |
...
| `glob` | 93153 | LLGo · deadcode drop | 1270363 | +1263.7% |
...
| `json-wasi` | 493590 | LLGo · deadcode drop | 2830255 | +473.4% |
...
| `llimport` | — | LLGo · deadcode drop | 33623702 | — |
...
| `path-report` | 116889 | LLGo · deadcode drop | 1614063 | +1280.9% |
...
| `sha-wasi` | 287449 | LLGo · deadcode drop | 2148131 | +647.3% |
...
| `word-count` | 86834 | LLGo · deadcode drop | 1242025 | +1330.3% |
