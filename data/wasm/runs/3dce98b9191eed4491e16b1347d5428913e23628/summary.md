...
| `conv-wasi` | 2608055 | LLGo · no LTO | 2147197 | -17.7% |
| `conv-wasi` | 2608055 | LLGo · deadcode drop | 1491186 | -42.8% |
| `conv-wasi` | 2608055 | LLGo · full LTO (GlobalDCE off) | 1518232 | -41.8% |
| `conv-wasi` | 2608055 | LLGo · full LTO + GlobalDCE | 1069489 | -59.0% |
...
| `json-wasi` | 3314554 | LLGo · no LTO | 3046163 | -8.1% |
| `json-wasi` | 3314554 | LLGo · deadcode drop | 2126756 | -35.8% |
| `json-wasi` | 3314554 | LLGo · full LTO (GlobalDCE off) | 2184607 | -34.1% |
| `json-wasi` | 3314554 | LLGo · full LTO + GlobalDCE | 1609188 | -51.5% |
...
| `sha-wasi` | 2780938 | LLGo · no LTO | 2411116 | -13.3% |
| `sha-wasi` | 2780938 | LLGo · deadcode drop | 1736847 | -37.5% |
| `sha-wasi` | 2780938 | LLGo · full LTO (GlobalDCE off) | 1704122 | -38.7% |
| `sha-wasi` | 2780938 | LLGo · full LTO + GlobalDCE | 1258761 | -54.7% |
...
| `conv-wasi` | 201149 | LLGo · no LTO | 2147197 | +967.5% |
| `conv-wasi` | 201149 | LLGo · deadcode drop | 1491186 | +641.3% |
| `conv-wasi` | 201149 | LLGo · full LTO (GlobalDCE off) | 1518232 | +654.8% |
| `conv-wasi` | 201149 | LLGo · full LTO + GlobalDCE | 1069489 | +431.7% |
...
| `json-wasi` | 493590 | LLGo · no LTO | 3046163 | +517.1% |
| `json-wasi` | 493590 | LLGo · deadcode drop | 2126756 | +330.9% |
| `json-wasi` | 493590 | LLGo · full LTO (GlobalDCE off) | 2184607 | +342.6% |
| `json-wasi` | 493590 | LLGo · full LTO + GlobalDCE | 1609188 | +226.0% |
...
| `sha-wasi` | 287449 | LLGo · no LTO | 2411116 | +738.8% |
| `sha-wasi` | 287449 | LLGo · deadcode drop | 1736847 | +504.2% |
| `sha-wasi` | 287449 | LLGo · full LTO (GlobalDCE off) | 1704122 | +492.8% |
| `sha-wasi` | 287449 | LLGo · full LTO + GlobalDCE | 1258761 | +337.9% |
